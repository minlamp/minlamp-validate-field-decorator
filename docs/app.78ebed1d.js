...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "78ebed1d1b83df6431b0";
...
function (_React$Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(App, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h2", null, "base example"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(InputWithValidate, {
        name: "username",
        value: data.username,
      ...
      }), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(InputWithValidate, {
        name: "password",
        type: "password",
        value: data.password,
      ...
      }), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(RadioWithValidate, {
        name: "sex",
        value: data.sex,
...
var validate = function validate(rule, value) {
  ...
  var params = Array.isArray(param) ? param.unshift(value) : [value, param]; // 优先调用自定义验证方法
...
/******/ });
//# sourceMappingURL=app.78ebed1d.js.map